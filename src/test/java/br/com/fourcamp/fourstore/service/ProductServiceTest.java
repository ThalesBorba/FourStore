...
import static br.com.fourcamp.fourstore.constants.Constants.INDEX;
import static br.com.fourcamp.fourstore.constants.Constants.SKU;
...
class ProductServiceTest {
    ...
    void whenFindBySkuWithDetailsShouldReturnDetailedProduct() {
        ...
        assertEquals(BigDecimal.valueOf(10), response.getBuyPrice());
        assertEquals(BigDecimal.valueOf(30), response.getSellPrice());
